    ...
    return (
        ...
        <div className='animation-area'>
            ...
            <div className='about-text' >
                ...
                <br/>
                <br/>
                More than a year experience working within a global team has not only immensely improved his technical skills, but also soft skills like time-management, research, communication, teamwork, problem-solving and people skills. Currently holds 4 university degrees, with the most recent ones (double degree) from Finland and Germany. Recently completed additional studies in IT (Principles of Progamming Graphical User Interfaces), from the University of Tampere, Finland. 
                <br/>
                <br/>
