            ...
            <Title title='Coaching | mentoring | teaching' />
                <div className='portfolios-center' >
                        ...
                        <article className='portfolio' >
                            ...
                            <p>We recently made a <a href='https://youtu.be/MjGOpq7E4Bs'>video</a> about acquiring our first property (a new build 3 bedroom in Ireland) in our 20s. To help you work towards your journey of financial independence, we can organize a 121 session where you learn the following:</p>
                        ...
                        <article className='portfolio' >
                            ...
                            <p>With bachelor’s, 3 master’s degrees and certifications in Education and Technical disciplines from 3 different countries, as well as working for one of the biggest tech companies ever, we have got the right educational background, experiences and skills to educate and serve you.</p>
                        </article> 
                </div>
            </section>
    )
