          ...
          <nav className='navbar'>
            <div className='nav-center'>
                <div className='nav-header'>
                  ...
                  >
                      {isOpen ? <CloseIcon className='nav-icon nav-icon-animate' data-aos='flip-right'/> : <FaAlignRight className='nav-icon' data-aos='flip-up'/> }
                  </button>
                </div>
                ...
                <ul className='nav-links'>
                    ...
                    <li>
                      <Link to='./about' title='Learn about us' >About</Link>
                    </li>
                    <li>
